...
We strongly recommend including each of the five main stimulus conditions (bodies, characters, faces, objects, places) in the localizer regardless of the specific region/s you are interested in defining, as this provides a stronger test of selectivity compared to only contrasting responses between a few categories. To include other stimulus conditions in the localizer, create a new fork of the repository and follow the instructions below: 
